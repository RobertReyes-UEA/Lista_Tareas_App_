...
class AppTkinter:
    def __init__(self, root, servicio):
        ...
        self.root.title("Lista de Tareas con Atajos")
        ...
        # ---------------- ATAJOS DE TECLADO ----------------
        self.root.bind("c", self.completar_tarea_evento)     # tecla C
        self.root.bind("C", self.completar_tarea_evento)

        self.root.bind("<Delete>", self.eliminar_tarea_evento)  # tecla Delete
        self.root.bind("d", self.eliminar_tarea_evento)         # tecla D

        self.root.bind("<Escape>", self.salir_app)  # cerrar app
